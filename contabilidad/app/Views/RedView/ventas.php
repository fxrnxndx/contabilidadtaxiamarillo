        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form onsubmit="setTotal(event)">
              ...
              Cambiar por: <input type="number" class="form-control" id="total_id" placeholder="Ingresar total"
                ...
                <tbody id="myTable">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <button class="btn btn-primary" type="button"
                        onclick="ChangeTotal('<?php echo $row->id_ventas; ?>',this)">Cambiar</button>
                    </td>
                    <td>
...
<script>
  ...
  function ChangeTotal(id, element) {
    ticketId = id;
    document.getElementById("id_ticket").value = ticketId;
    console.log(id, element);
  ...
  function setTipoPago(e) {
    ...
    let formData = new FormData(e.target);
    formData.append('id_sale', ticketId);
    // formData.append('tipo_pago', document.getElementById("tipo_pago_id").value);
