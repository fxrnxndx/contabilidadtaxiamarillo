      ...
      <div class="card-content">
          <div class="row row-group ">
              <div class="col-8 border-light">
                  <div class="card-body">
                    <h5 class="text-white mb-0">Nuevo concepto <span class="float-right"><i class="zmdi zmdi-account-add"></i></span></h5>
...
<!--FIN AGREGAR -->
 ...
 <form action="<?php  echo(base_url("Home/AgregarConcepto"));?>" method="post" accept-charset="utf-8">
 <input type="hidden"  name="idconcepto" id="idconcepto" value="0">
 <div class="row mt-3" id="formulario" style="display:none">
      <div class="col-lg-6">
         <div class="card">
           <div class="card-body">
           <div class="card-title">Registrar Concepto </div>
           <hr>
...
<div class="row" >
       <div class="col-12 col-lg-12">
         <div class="card">
           <div class="card-header"><h4>Lista de conceptos</h4>
              ...
              <ul class="pagination " id="myPager"></ul>
                   ...
                   <table class="table align-items-center table-flush table-borderless" id="myTableS">
                    <thead>
                     ...
                     <tbody id="myTable">
                <?php if( $dataConceptos!=false): ?>
                <?php foreach ($dataConceptos->getResult() as $row): ?>
                      <tr>
                      <td><?php echo $row->id_concepto; ?></td>
                      <td><?php echo $row->nombre; ?></td>
                      <td><?php echo $row->estatus; ?>
                       <td><a href="javascript:void();" onclick="editar('<?php echo $row->nombre; ?>','<?php echo $row->estatus; ?>','<?php echo $row->id_concepto; ?>')"><i class="zmdi zmdi-brush"></i> <span>Editar</span></a>
                      </td>
...
function editar(Nombre,Estatus,idconcepto){
