...
function LivIconsEvoDefaults() {
	...
	var defaultOptions = {
		...
		pathToFolder: '/ulsistema/public/assets/LivIconsEvo/svg/', //the path from root of your site to folder with icons. Also may be as URL, like 'http://yoursite.com/path/to/LivIconsEvo/svg/'
