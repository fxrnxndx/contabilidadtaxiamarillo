  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       SUPERVISOR AGREGADO CORRECTAMENTE
      </div>
      ...
      <div class="card-content">
          <div class="row row-group ">
              <div class="col-8 border-light">
                  <div class="card-body">
                    <h5 class="text-white mb-0">Nuevo supervisor <span class="float-right"><i class="zmdi zmdi-account-add"></i></span></h5>
...
<!--FIN AGREGAR -->
 ...
 <form action="<?php  echo(base_url("Home/AgregarSupervisor"));?>" method="post" accept-charset="utf-8">
 <input type="hidden"  name="idsupervisor" id="idsupervisor" value="0">
              ...
              <ul class="pagination " id="myPager"></ul>
                   ...
                   <table class="table align-items-center table-flush table-borderless" id="myTableS">
                    <thead>
                     ...
                     <tbody id="myTable">
                <?php if( $TodosSupervisores!=false): ?>
                <?php foreach ($TodosSupervisores->getResult() as $row): ?>
                      <tr>
                      ...
                      <td><a href="javascript:void();" onclick="editar('<?php echo $row->nombre; ?>','<?php echo $row->apellidos; ?>','<?php echo $row->telefono; ?>','<?php echo $row->id_empresa_fk; ?>','<?php echo $row->porcentaje_ganancia; ?>','<?php echo $row->estatus; ?>','<?php echo $row->id_supervisor; ?>')"><i class="zmdi zmdi-brush"></i> <span>Editar</span></a>
                      </td>
...
document.addEventListener("DOMContentLoaded", function() {
  if(document.getElementById("notificacion").value=="1")
     ...
     if(document.getElementById("notificacion").value=="2")
		 {
			toastr.success("SUPERVISOR AGREGADO");
      <?php $this->session->set('NOTIFICACION','0'); ?>
		 }
     if(document.getElementById("notificacion").value=="3")
		 {
			toastr.error("YA EXISTE SUPERVISOR CON ESOS DATOS");
      <?php $this->session->set('NOTIFICACION','0'); ?>
		 }
...
function BuscarTexto(){
  ...
  document.getElementById('idsupervisor').value="0";
...
function editar(Nombre,Apellidos,Telefono,Empresa,Porcentaje,Estatus,idsupervisor){
