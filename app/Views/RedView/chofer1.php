      ...
      <div class="col-lg-6">
         <div class="card">
           ...
           <div class="form-group ">
            ...
            <select class="form-control" aria-label="Default select example" id="Socio" name="socio" required>
              <option selected value="0">Seleccione un socio</option>
              <option value="1">Myrna</option>
...
function editar(NumeroEmpleado,Nombre,Apellidos,Telefono,Empresa,Porcentaje,Estatus,Id_chofer,Socio){
